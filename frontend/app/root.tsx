        ...
        <header className="border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-sm sticky top-0 z-50 flex-shrink-0">
          <nav className="container mx-auto px-4 py-3 flex justify-between items-center" aria-label="Navegación principal">
                  ...
                  <>
                    ...
                    {user.rol === "admin" && (
                      <>
                        ...
                        <Link to="/admin/io-management" className="text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 focus-visible:ring-1 focus-visible:ring-indigo-500 rounded-sm px-1">Import/Export</Link>
                      </>
                    )}
                  </>
                )}
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              >
                {isMounted ? (theme === 'light' ? <MoonIcon /> : <SunIcon />) : <MoonIcon />}
              </button>
              {user ? (
                ...
                <>
                  ...
                  {user.rol === "admin" && (
                    <>
                      ...
                      <Link to="/admin/io-management" className="text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 text-sm px-2 py-1 rounded-md focus-visible:ring-1 focus-visible:ring-indigo-500">Import/Export</Link>
                    </>
                  )}
                </>
              )}
...
export function ErrorBoundary() {
  ...
  if (isRouteErrorResponse(error)) {
    ...
    heading = "Error en la Aplicación";
    ...
    <html lang="es" className="h-full" suppressHydrationWarning>
      ...
      <body className="h-full flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-950 text-gray-900 dark:text-gray-100 p-4">
        <div role="alertdialog" aria-labelledby="error-heading" aria-describedby="error-message" className="max-w-md w-full bg-white dark:bg-gray-800 shadow-xl rounded-lg p-6 md:p-8 border-2 border-red-400 dark:border-red-600 text-center">
          <div className="mx-auto h-12 w-12 text-red-500 dark:text-red-400" aria-hidden="true">
